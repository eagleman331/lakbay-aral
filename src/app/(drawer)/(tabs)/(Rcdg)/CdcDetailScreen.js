import {
      ...
      <>
        <View className="flex-1 bg-slate-300">
          ...
          <View className="-top-5 h-4/5 w-full rounded-3xl bg-green-400">
            <Text className="mt-2 text-center text-xl font-semibold">OFFICE DETAILS</Text>
            ...
            <View className="mt-2 p-2">
              <Text className="font-bold">Areas:</Text>
            ...
            <View className="mt-10 flex-row" style={{ justifyContent: 'space-around' }}>
              <Pressable
                ...
                onPress={() =>
                  router.push({ pathname: '/(drawer)/(tabs)/(Rcdg)/RotcSchoolScreen' })
                }>
                <Animated.View
  ...
  export default CdcDetailScreen;
